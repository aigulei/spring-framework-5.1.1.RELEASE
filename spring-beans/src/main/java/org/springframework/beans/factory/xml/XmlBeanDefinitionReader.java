...
public class XmlBeanDefinitionReader extends AbstractBeanDefinitionReader {
	 ...
	 */
	/**
	 * 先对Resource资源封装成EncodedResource对象。
	 * 为什么需要将Resource封装成EncodedResource呢？
	 * 主要为了对Resource进行编码，保证内容读取的正确性
